class SuperHero:
    ...
    @health.setter
    def health(self, new_health_value: int):
        if new_health_value > 100:
            print("You can't set the health to more than 100")
        elif new_health_value < 0:
            print("You can't set the health to less than 0")
        else:
            self.__health = new_health_value
    ...
    def attributes(self):
        print('{} has {} health and {} power level'.format(self.name, self.__health, self.__power_level))
